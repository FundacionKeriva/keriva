        ...
        <footer className="footer">
            ...
            <div style={{marginTop:"150px"}}>
                <a href={facebookUrl} target="_blank">
                    <Image src='https://static.vecteezy.com/system/resources/previews/018/930/476/non_2x/facebook-logo-facebook-icon-transparent-free-png.png' alt='Facebook' width="80" height="80" />
                </a>

                <a href={instagramUrl} target="_blank">
                    <Image src='https://i.pinimg.com/originals/3b/21/c7/3b21c7efd2ba9c119fb8d361acacc31d.png' alt='Instagram' width="60" height="60" />
                </a>
            </div>
